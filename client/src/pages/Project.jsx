      ...
      (
        <>
          <div className="flex justify-between">
            <h1 className=" text-5xl text-black uppercase my-2 font-mono">{name}</h1>
            <Link
          ...
          <div className="flex justify-between">
          <h2 className="text-3xl uppercase my-4 font-bold text-black">Cliente: {client}</h2>
          ...
          <div className="flex justify-between">
            ...
            <div
              className="flex justify-center items-center gap-1 text-gray-500 cursor-pointer"
