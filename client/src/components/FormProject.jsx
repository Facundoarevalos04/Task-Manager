    ...
    >
     {
      ...
      <div className="mb-5">
        <label
          htmlFor="name"
          className="text-indigo-700 uppercase font-bold text-sm "
        >
          Nombre Proyecto
        </label>
        <input
      ...
      <button className={`${false ? "bg-green-600" : "bg-indigo-600"} w-full p-3 uppercase font-bold text-white rounded-lg ${false ? "hover:bg-green-500" : "hover:bg-indigo-500"}  transition-colors`}>
